...
class LocalTrip extends Model {
	...
	public static function getLocalTripFormData($trip_id) {
		...
		$employee_old = Employee::select('users.name as name', 'employees.code as code', 'designations.name as designation_name', 'entities.name as grade', 'employees.grade_id', 'employees.id', 'employees.gender', 'gae.two_wheeler_per_km', 'gae.four_wheeler_per_km','gae.local_trip_amount','sbus.id as sbu_id','sbus.name as sbu_name')
		...
		$trip->employee_old = $employee_old;
		$data['trip'] = $trip;
