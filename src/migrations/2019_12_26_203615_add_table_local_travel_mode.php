...
class AddTableLocalTravelMode extends Migration {
	/**
	 * Run the migrations.
	 *
	 * @return void
	 */
	public function up() {
		Schema::create('local_travel_mode_category_type', function (Blueprint $table) {
	...
	public function down() {
		Schema::dropIfExists('local_travel_mode_category_type');
	}
}
