...
app.component('eyatraReportsTripFinancierPaid', {
    ...
    controller: function(HelperService, $rootScope, $http, $scope) {
        ...
        $http.get(
            ...
            self.purpose_list = response.data.purpose_list;
            self.filter_outlet_id = response.data.filter_outlet_id;
            self.start_date = response.data.financier_paid_start_date;
            self.end_date = response.data.financier_paid_end_date;
            if (response.data.filter_purpose_id == '-1') {
                self.filter_purpose_id = '-1';
            } else {
                self.filter_purpose_id = response.data.filter_purpose_id;
            ...
            var trip_periods = response.data.financier_paid_start_date + ' to ' + response.data.financier_paid_end_date;
            self.trip_periods = trip_periods;
...
app.component('eyatraReportsTripEmployeePaid', {
    ...
    controller: function(HelperService, $rootScope, $http, $scope) {
        ...
        $http.get(
            ...
            self.purpose_list = response.data.purpose_list;
            self.filter_outlet_id = response.data.filter_outlet_id;
            self.start_date = response.data.employee_paid_start_date;
            self.end_date = response.data.employee_paid_end_date;
            if (response.data.filter_purpose_id == '-1') {
                self.filter_purpose_id = '-1';
            } else {
                self.filter_purpose_id = response.data.filter_purpose_id;
            ...
            var trip_periods = response.data.employee_paid_start_date + ' to ' + response.data.employee_paid_end_date;
            self.trip_periods = trip_periods;
...
app.component('eyatraReportsLocalTripFinancierPaid', {
    ...
    controller: function(HelperService, $rootScope, $http, $scope) {
        ...
        self.hasPermission = HelperService.hasPermission;
        $http.get(
            trip_trip_financier_paid_filter_data_url
        ).then(function(response) {
            self.employee_list = response.data.employee_list;
            self.outlet_list = response.data.outlet_list;
            self.purpose_list = response.data.purpose_list;
            self.filter_outlet_id = response.data.filter_outlet_id;
            self.start_date = response.data.financier_local_paid_start_date;
            self.end_date = response.data.financier_local_paid_end_date;
            if (response.data.filter_purpose_id == '-1') {
                self.filter_purpose_id = '-1';
            } else {
                self.filter_purpose_id = response.data.filter_purpose_id;
            ...
            var trip_periods = response.data.financier_local_paid_start_date + ' to ' + response.data.financier_local_paid_end_date;
            self.trip_periods = trip_periods;
