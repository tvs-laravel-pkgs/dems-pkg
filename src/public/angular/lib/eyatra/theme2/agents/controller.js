                        ...
                        agent_delete_url + '/' + id,
                            ...
                            if (response.data.success) {
                                ...
                                setTimeout(function() {
                                    ...
                                    $('#agent_list').DataTable().ajax.reload(function(json) {}); $location.path('/eyatra/agents');
                                    // $scope.$apply();
                                }
                                else {
                                    $noty = new Noty({
                                ...
                                $form_data_url
                                    ...
                                    if (!response.data.success) {
                                        ...
                                        setTimeout(function() {
                                            ...
                                            $location.path('/eyatra/agents') $scope.$apply() return;
                                        }
                                                        ...
                                                        .done(function(res) {
                                                                ...
                                                                if (!res.success) {
                                                                    ...
                                                                    setTimeout(function() {
                                                                        ...
                                                                        $location.path('/eyatra/agents') $scope.$apply()
                                                                    }
                                                                })
                                                            .fail(function(xhr) {
                                                                $('#submit').button('reset');
