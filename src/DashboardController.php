...
class DashboardController extends Controller {
	...
	public function trip_details($start_date, $end_date, $outlet_id) {
		...
		$total_outstation_claim_requested = Trip::whereIN('trips.status_id', [3023, 3024, 3025, 3029, 3030, 3034, 3036])->where('trips.start_date', '>=', $start_date)->where('trips.end_date', '<=', $end_date);
